...
gulp.task('css-sorting', function() {
	return gulp.src(['src/sass/**/*.scss', '!src/sass/mixins/**/*.scss', '!src/sass/normalize/**/*.scss', '!src/sass/base/_02_fonts.scss'])
		.pipe(postcss([
			sorting({
				"order": [
					"custom-properties",
...
gulp.task('watch', function() {
	...
	gulp.watch(['src/images/*', '!src/images/*.{png,jpg,gif}'], ['copy-images']);
